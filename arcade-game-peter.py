...
class SpaceShooter(arcade.Window):
    ...
    def setup(self):
        ...
        # Setup the player
        self.player = arcade.Sprite(os.path.join("images", "jet.png"), SCALING)
    ...
    def add_enemy(self, delta_time: float):
        ...
        enemy = FlyingSprite(os.path.join("images", "missile.png"), SCALING)
        ...
        enemy.velocity = (random.randint(-100, -50),random.randint(-2,2))
    ...
    def on_key_press(self, symbol, modifiers):
        ...
        if symbol == arcade.key.SPACE:
            laser = FlyingSprite(os.path.join("images", "laserRed16.png"), SCALING)
            laser.left = self.player.right + 1
            laser.center_y = self.player.center_y
            laser.velocity = (100,0)
    ...
    def on_update(self, delta_time: float):
        ...
        if self.player.collides_with_list(self.enemies_list):
            self.collided = True
            print("time survived:", self.survival_timer)
            self.collision_timer = 0.0
